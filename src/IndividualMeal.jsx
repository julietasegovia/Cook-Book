...
export default function IndividualMeal() {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="flex pt-20 gap-32">
                <img src={meal.strMealThumb} alt={meal.strMeal} width={350} className="rounded-3xl"></img>
                <div className="flex flex-col items-center">
                <h3 className="text-7xl pt-10">{meal?.strMeal}</h3>
