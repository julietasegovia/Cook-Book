    ...
    return(
        <div className="flex justify-center flex-col items-center">
            <div className="items-center flex justify-center pt-16 w-full">
                <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Look for a recipe..." className="border rounded-md h-10 text-center flex justify-center text-gray-700 w-1/2"/>
            </div>
            ...
            <div className="pt-10 justify-center items-center grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16">
                {data?.meals?.map((meal) => (
                    <div key={meal.idMeal} className="flex justify-center flex-col text-center items-center w-full">
